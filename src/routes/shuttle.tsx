...
import { ShuttleScreen } from "#/domain/timetable/components/shuttle-screen";
...
function ShuttleRoute() {
  ...
  return (
    <ErrorBoundary
      suspenseFallback={
        <Loading containerClassName="min-h-app-main" title="셔틀 시간표를 불러오는 중이에요..." />
      }
    >
      <ShuttleScreen weekday={weekday} />
    </ErrorBoundary>
  );
}
